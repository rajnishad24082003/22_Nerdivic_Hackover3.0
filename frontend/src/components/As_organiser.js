function As_organiser(){
    ...
    return(<div style={{"backgroundColor":" #f5fdfb"}}>
        ...
        <h1><i class="fas fa-user"></i><div style={{"color":"#189671"}}>Organizer</div> </h1>
    <p>Sign in to access you account</p>
    <hr/>
    <div className="section">
    </div>
    <div className="section">
    <a href="http://localhost:5000/auth/google/As_organiser" className="btn text-light mt-3" style={{"backgroundColor":"#32CD32"}}><i className="fab fa-google"></i> SignIn with Google</a>
